        ...
        <div className="min-h-screen bg-white dark:bg-gray-800 rounded-xl overflow-hidden">
            <div className="p-1">
                ...
                <div className="flex items-center justify-between mb-4">
                    ...
                    >
                        <XMarkIcon className="w-2 h-2 text-olive-100" />
                    </button>
                ...
                <div className="flex gap-3 mt-4">
                    ...
                    <button
                        ...
                        className="flex-1 px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 flex items-center justify-center gap-1"
                    >
