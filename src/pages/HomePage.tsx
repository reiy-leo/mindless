  ...
  return (
    <div className="flex-1 overflow-auto p-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">{t('navigation.home')}</h1>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-gray-800 mb-4">即将到期的习惯</h2>
          <div className="bg-white rounded-lg shadow p-6">
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-800 mb-4">即将到来的倒数日</h2>
          <div className="bg-white rounded-lg shadow p-6">
