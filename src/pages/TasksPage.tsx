...
function TaskDetailPanel({
  ...
  const dateDisplayText = dateMode === 'single'
    ? formatShortDate(activeTask.dueDate, activeTask.dueTime)
    : activeTask.dueDate || activeTask.endDate
      ? `${formatShortDate(activeTask.dueDate, activeTask.dueTime)} → ${formatShortDate(activeTask.endDate, activeTask.endTime)}`
      : '';
    ...
    <div className="flex flex-col h-full border-l border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
      ...
      <div className="flex items-center justify-between px-4 pt-2 pb-0">
        ...
        <div className="flex items-center gap-1 flex-shrink-0">
          ...
          <div className="relative" onBlur={(e) => { if (!e.currentTarget.contains(e.relatedTarget as Node)) setShowDatePicker(false); }} tabIndex={-1}>
            <button
