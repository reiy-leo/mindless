...
export default function MediaListItem({ item, onClick, onContextMenu }: MediaListItemProps) {
  ...
  return (
    ...
    >
      {/* Cover Thumbnail */}
      <div className="w-12 h-16 bg-gray-200 dark:bg-gray-700 rounded overflow-hidden shrink-0">
        {item.cover ? (
      ...
      <div className="flex-1 min-w-0">
        <h3 className="text-sm font-medium text-gray-900 dark:text-gray-100 truncate">{item.title}</h3>
