...
function InlineAddInput({
  ...
  return (
    <div className="flex items-center gap-2 px-3 py-2 bg-white dark:bg-gray-800 rounded-lg shadow-sm">
      <div className="w-4 h-4 rounded border-2 border-dashed border-gray-300 dark:border-gray-600 shrink-0" />
      <input
        ref={inputRef}
        type="text"
        value={value}
  ...
  return (
    <div ref={setNodeRef} style={style} className="flex items-center gap-1 group/sort">
      <button
        ...
        {...listeners}
        onClick={(e) => e.stopPropagation()}
        className="p-1 rounded hover:bg-gray-100 dark:hover:bg-gray-700 opacity-0 group-hover/sort:opacity-100 transition-opacity cursor-grab active:cursor-grabbing shrink-0 touch-none absolute -left-5"
