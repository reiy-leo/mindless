import type { TimezoneFormat } from '&/useAppStore'
import { useAppStore } from '&/useAppStore'
import { ChevronLeft, ChevronRight, Moon, Rainbow, Sun, Sunrise } from 'lucide-react'
      ...
      <div className="p-2">
        ...
        <div className="grid grid-cols-7 mb-0.5">
          {WEEKDAY_KEYS.map((key) => (
            <div
              key={key}
              className="aspect-square flex items-center justify-center text-xs text-gray-500 dark:text-gray-400 py-0.5"
            >
        ...
        {!hideTime && (
          <div className="mt-2 pt-2">
            <label className="text-[10px] text-gray-500 dark:text-gray-400 block mb-0.5">{t('tasks.due_time')}</label>
            <input
              type="time"
              value={localTime}
