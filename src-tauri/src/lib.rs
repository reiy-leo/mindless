...
pub fn run() {
    Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // Items
            commands::get_item_groups,
            commands::create_item_group,
            commands::update_item_group,
            commands::delete_item_group,
            commands::get_items,
            commands::get_item_by_id,
            commands::create_item,
            commands::update_item,
            commands::delete_item,
            commands::get_item_purchase_lines,
            commands::get_item_linked_items,
            commands::link_item,
            commands::unlink_item,
            // Attachments
            commands::create_attachment,
            commands::get_attachments_by_task,
            commands::get_attachments_by_owner,
